...
public static void main (String[] args) {
	...
	do {// do while loop for menu operation
		...
		case 2:
			...
			System.out.println("Please enter the book ID you wish to purchase from the list above: ");// get book id and number of copies from user
			id =  input.nextInt();
			idCheck = -1;
			do {//check for correct book id
